...
export 'package:plenty/features/garden/domain/repositories/plant_repository.dart'
    show AddPlantResult;
...
class PlantRepository {
  ...
  /// Retrieves plant species catalog using Cache-First strategy (local SQLite first, fallback to Perenual API).
