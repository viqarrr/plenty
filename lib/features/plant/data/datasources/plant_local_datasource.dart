...
class PlantLocalDataSourceImpl implements PlantLocalDataSource {
  static const List<PlantModel> defaultCatalog = [
    PlantModel(
      id: 'cat_1',
      ...
      toxicity: 'Beracun bagi kucing, anjing, dan manusia jika tertelan. Mengandung kristal kalsium oksalat.',
      description: 'Ficus lyrata, umumnya dikenal sebagai Fiddle Leaf Fig, adalah spesies pohon ara yang berasal dari hutan hujan tropis Afrika Barat. Sangat populer sebagai tanaman hias dalam ruangan dengan daunnya yang lebar menyerupai biola.',
      maxHeight: '2-3 meter',
      growthRate: 'Sedang',
      growthCycle: 'Perenial (Menahun)',
      pruningSeason: 'Musim Semi & Panas',
      flowerStatus: 'Jarang Berbunga',
      pests: 'Rentan terhadap kutu putih, tungau laba-laba, dan serangga sisik.',
    ...
    PlantModel(
      ...
      description: 'Dracaena trifasciata adalah spesies tumbuhan berbunga dalam keluarga Asparagaceae, yang berasal dari Afrika Barat tropis. Dikenal karena daunnya yang kaku dan tegak, tanaman ini sangat toleran terhadap kelalaian penyiraman.',
  ...
  static const List<PlantModel> initialSeedPlants = [
    PlantModel(
      id: 'default_1',
      name: 'Monstera',
      ...
      description: 'Monstera deliciosa adalah tanaman hias ikonik dengan daun berlubang indah.',
      maxHeight: '2-3 meter',
      growthRate: 'Sedang',
  ...
  Future<String> getProfileName() async {
    return PreferenceHandler.profileName;
  }

  @override
  Future<void> setProfileName(String name) async {
    await PreferenceHandler.setProfileName(name);
  }
