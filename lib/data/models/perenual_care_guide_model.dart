...
class PerenualCareGuideModel {
  ...
  factory PerenualCareGuideModel.fromJson(Map<String, dynamic> json) {
    ...
    // Defensively parse section list (can be 'section' or 'sections')
  ...
  /// Returns the specific advice for watering if available.
  ...
  /// Returns the specific advice for sunlight if available.
  ...
  /// Returns the specific advice for pruning if available.
